//
//  MyUnion_SettingTableViewCell.m
//  Union
//
...
@interface MyUnion_SettingTableViewCell ()
...
@implementation MyUnion_SettingTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _picImageView.tintColor = [UIColor blackColor];
        
        _picImageView.image = [[UIImage imageNamed:@"iconfont-setting"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
