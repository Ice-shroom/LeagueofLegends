...
- (void)loadData{
    ...
    id caCheData = [[DataCache shareDataCache] getDataForDocumentWithDataName:@"FreeHeroData"];
    ...
    [self.manager GET:[NSString stringWithFormat:kUnion_Ency_HeroListURL , @"free"] parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if (responseObject != nil) {
            ...
            [[DataCache shareDataCache] saveDataForDocumentWithData:responseObject DataName:@"FreeHeroData"];
...
-(void)didLoadData:(id)data{
    ...
    [[DataCache shareDataCache] saveDataForDocumentWithData:data DataName:@"FreeHeroData"];
